...
<div class="container-fluid p-3 bg-light">
  <div class="row">
    <div class="col-md-3 text-success">
     ...
     <!-- login hone ke baaad phir se home page ko redirect kare -->
     <c:if test="${not empty userobj}">
       <div class="col-md-3">
       <a href="checkout.jsp" class=""><i class="fa-solid fa-cart-shopping fa-2x"></i></a>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <a href="settings.jsp" class="btn btn-light my-2 my-sm-0" type="submit"><i class="fa-solid fa-gear"></i>Setting</a>
