...
<%@page import="com.entity.Add_to_cart"%>
...
<body style="background-color:#f0f1f2;">
  ...
  <!-- show message when Remove book from add to card  -->
    ...
    <div class="row p-2">
     <div class="col-md-6">
       <div class="card">
        ...
        List<Add_to_cart> cart =dao.getBookByUser(u.getID());
        double totalPrice=0.00;
        for(Add_to_cart c: cart)
        {
 ...
 <!-- Second column for user details -->
 <div class="col-md-6">
       <div class="card">
         <div class="card-body">
            ...
            <input type="hidden" value="${userobj.ID }" name="id">
			  <div class="form-row">
			    <div class="form-group col-md-6">
			      ...
			      <input type="text" name="username" class="form-control" id="inputEmail4" value="${userobj.name }" required><!--value="<%=u.getName()%>" readonly="readonly"-->
			    </div>
			    <div class="form-group col-md-6">
			  ...
			  <div class="form-row">
			    ...
			    <div class="form-group col-md-6">
			      ...
			      <input type="number" name="pin_code"class="form-control" id="inputPassword4" required>
			    </div>
			  </div>
